...
part of 'character_collection.dart';
...
const CharacterCollectionSchema = CollectionSchema(
  ...
  indexes: {
    ...
    r'specie': IndexSchema(
      id: -6893714500257793010,
      name: r'specie',
      unique: false,
      replace: false,
      properties: [
...
void _characterCollectionSerialize(
  ...
  writer.writeString(offsets[2], object.specie);
...
CharacterCollection _characterCollectionDeserialize(
  ...
  object.specie = reader.readString(offsets[2]);
...
extension CharacterCollectionQueryWhere
  ...
  QueryBuilder<CharacterCollection, CharacterCollection, QAfterWhereClause>
      specieNotEqualTo(String specie) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
...
extension CharacterCollectionQueryFilter on QueryBuilder<CharacterCollection,
  ...
  QueryBuilder<CharacterCollection, CharacterCollection, QAfterFilterCondition>
      specieContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'specie',
        value: value,
  ...
  QueryBuilder<CharacterCollection, CharacterCollection, QAfterFilterCondition>
      specieMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'specie',
        wildcard: pattern,
...
extension CharacterCollectionQueryWhereDistinct
  ...
  QueryBuilder<CharacterCollection, CharacterCollection, QDistinct>
      distinctBySpecie({bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension CharacterCollectionQueryProperty
  ...
  QueryBuilder<CharacterCollection, String, QQueryOperations> specieProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'specie');
    });
  }

  QueryBuilder<CharacterCollection, String, QQueryOperations> statusProperty() {
    return QueryBuilder.apply(this, (query) {
